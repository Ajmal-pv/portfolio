        ...
        >
          <div className="content">
            <p className="about_aboutText__6K4t_ about_highlightFirstLetter__Q7tbo">
              Hey! I`m Muhammed Ajmal PV, if you haven`t already gathered that by now. I`m a
              ...
              <div className="headinglinks_links__0X2vp">
                <span>
                  <a
                    target="_blank"
                    rel="nofollow"
                    href="https://www.linkedin.com/in/muhammad-ajmal-pv/"
                  >
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
                ...
                <span>
                  <a
                    target="_blank"
                    rel="nofollow"
                    href="https://github.com/Ajmal-pv"
                  >
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
